...
Прототип проверен на 47 синтетических сценариях и 74 автоматических тестах. В штатной группе из 34 проходов все диагностические кандидаты уложились в допуск; максимальная ошибка составила 1,28 мм. Контроль качества принял 32 прохода, ещё 2 получили review. Расчёты установки и алгоритм приведены в разделах 2-7, состав испытаний - в разделах 9-11.
...
**Точность поиска.** Алгоритм даёт численное приближение; global_optimum_certified = false. Проверяются аналитические коробки, тетраэдр, равные минимумы клина и 27 полных облаков с независимым differential_evolution. Наибольшее отношение объёмов: 1,001871. Покомпонентное сравнение рёбер прошло на 27 облаках; максимальная нормированная разность: 0,15. Для случайных оболочек это сравнение численных решений; глобальный минимум остаётся несертифицированным.
...
| p50 / p95 / max обработки облака | 154,01 / 291,14 / 353,12 мс |
...
Успешно выполнены тесты: 74. Проверяются аналитическая геометрия, допуски, облака с выбросами и тонкими выступами, идентификаторы сенсоров, скрытый сбой энкодера, CLI и HTTP-доставка. Полный набор находится в tests; журнал прогона - results/tests.xml.

Независимый differential_evolution использует seed 110, 210, 310, до 600 итераций и популяцию 60 ориентаций. Проверяются клин, Г-образная и асимметричная призмы, 20 случайных оболочек и четыре повёрнутые поверхности эллипсоида. Порог сравнения объёмов - 0,5%; максимум 1,001871. Для каждого случая сохраняется также ошибка каждого ребра относительно лучшего независимого решения. Численно равные лучшие свидетели учитываются совместно; для клина заданы две аналитические коробки равного объёма. Прототип выбирает каноническую коробку 180 × 120 × 90 мм.
...
| --- | --- | --- |
| OBB: 3,7 млн точек, 8 вершин | 1147,14 | 1453,58 |
| OBB: 3000 точек и вершин | 217,10 | 289,56 |
| OBB: 10 000 точек и вершин | 642,18 | 752,72 |
| OBB: 3,7 млн точек, 10 000 вершин | 1892,79 | 2103,42 |
| Полная функция measure: 3,7 млн точек, 10 000 вершин | 2363,12 | 2464,45 |
